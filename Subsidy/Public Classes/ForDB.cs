...
namespace Subsidy.Public_Classes
{
    class ForDB
    {
        ...
        public static string M_str_sqlcon = "Data Source=KOURIKKAN-PC;Database=Subsidy;User id=kourikkan;PWD=woshilihan";
        //public static string M_str_sqlcon = @"Data Source=PC-20141024KWVB;Initial Catalog=Subsidy;Integrated Security=True";

        public static int Login_n = 0;  //用户登录与重新登录的标识
        public static string AllSql = "Select * from tb_Main";    //存储职工基本信息表中的SQL语句
